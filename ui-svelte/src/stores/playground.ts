...
export type PlaygroundTab = "chat" | "images" | "video" | "3d" | "speech" | "audio";
...
if (!["chat", "images", "video", "3d", "speech", "audio"].includes(get(selectedTabStore))) selectedTabStore.set("chat");

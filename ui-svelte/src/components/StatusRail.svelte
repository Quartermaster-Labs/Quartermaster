...
<div
  class="flex items-center gap-4 rounded-tl-lg border-t border-l border-border bg-rail px-4 h-10 shrink-0 text-label overflow-x-auto whitespace-nowrap pretty-scroll"
>
  <!-- Loaded model(s) -->

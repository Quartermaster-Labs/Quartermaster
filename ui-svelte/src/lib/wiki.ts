...
export const WIKI_CATEGORIES: { title: string; ids: string[] }[] = [
  ...
  { title: "Playground", ids: ["playground-chat", "load-testing", "playground-login", "web-search", "youtube", "qm-tools", "images", "upscale", "segmentation", "speech-audio", "rerank-embed", "settings"] },

...
func TestParseCmd_ModelPath(t *testing.T) {
	cases := []struct {
		...
		{"vllm serve gguf", "vllm serve /models/q.gguf --port 9000 --quantization gguf", "/models/q.gguf"},
		{"vllm serve HF folder", "vllm serve /models/meta/Llama-3-8B --port 9000", "/models/meta/Llama-3-8B"},
		{"serve with no positional", "ollama serve --port 9000", ""},
